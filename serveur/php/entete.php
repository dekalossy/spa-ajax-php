...
<!-- Bootstrap CSS -->
   ...
   <!--------------------------------------------------------------------->
	...
	<body  onload="chargeSelect(); panier();">
		<!---start-wrap--->
		<div class="wrap">
			<!---start-header--->
			<div class="header">
			...
			<div class="sub-header">
				...
				<div class="sub-header-right">
					...
					<ul>
						...
						<li style="color:#fff"><?php if(isset($_GET['confirmkey']) AND $_GET['confirmkey'] > 0  AND isset($_GET['nom'])){  ?><a href="deconnexion.php" >Deconnexion</a><?php }else{ echo "" ;}?>
						</li>
						
						<li><a href="#" data-toggle="modal" data-target="#demoModal">MON COMPTE</a></li>
						<li><a href="#" data-toggle="modal" data-target="#modalPanier" class="modalPanier">PANIER <img src="../elementActif/images/cart.png" title="cart" /><span>0</span></a></li>
					</ul>
				</div>
				<div class="clear"> </div>
			</div>
               ...
               <div class="">
                   <div class="pull-up-lg">
                       <div class="container-fluid">
                           <div class="row">
                               <div class="col-md-10 mx-auto pb-5 modalCol10">
                                   <div class="bg-light rounded shadow-sm px-3 py-3 cartBoxe">
                                   	<h5 >LISTE D'ACHATS</h5>
                                   	<table id='list'  class="table table-striped table-hover"></table>


                                   	<p>
									<i>** Merci d'effectuer votre paiement...!</i></label>
									</p>
